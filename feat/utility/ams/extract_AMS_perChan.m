function [ns_ams] = extract_AMS_perChan(sub_gf, nChnl, freq, win_len, win_shift)
...
s_frame_len = (win_len / Srate * 1000);   % spectrum frame length in ms
...
AMS_frame_step = floor(AMS_frame_len/(win_len/win_shift));
