function [trained_net, global_optimizer] = train_net(training_feat, training_label, validation_feat, validation_label, net, optimizer)
...
for epoch = 1:optimizer.sgd_max_epoch
    ...
    fprintf('%-20d %-20.5f %.5f\n', epoch, cost_sum, validation_mse);
